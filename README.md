...
[![License: Apache-2.0](https://img.shields.io/github/license/Genspark-ai/PROVAOffice)](LICENSE)
[![Latest release](https://img.shields.io/github/v/release/Genspark-ai/PROVAOffice)](https://github.com/Genspark-ai/PROVAOffice/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/Genspark-ai/PROVAOffice/total)](https://github.com/Genspark-ai/PROVAOffice/releases)

[Website](https://PROVAOffice.ai/) · [Download](https://github.com/Genspark-ai/PROVAOffice/releases/latest) · [Demo](https://www.youtube.com/watch?v=B2pLdMX95v4)

PROVAOffice is a free, open-source alternative to Microsoft Office for macOS,
...
[![Meet PROVAOffice — the world's first full-featured open-source AI Office (video)](https://img.youtube.com/vi/B2pLdMX95v4/maxresdefault.jpg)](https://www.youtube.com/watch?v=B2pLdMX95v4)
...
| ------------------------------------ | ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| **macOS** — Apple Silicon (arm64)    | macOS 11+                                             | [GenOffice-0.7.204-arm64.dmg](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/GenOffice-0.7.204-arm64.dmg)   |
| **macOS** — Intel (x64)              | macOS 11+                                             | [GenOffice-0.7.204.dmg](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/GenOffice-0.7.204.dmg)               |
| **Windows** (x64)                    | Windows 10+                                           | [PROVAOfficeSetup-v0.7.204.exe](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/PROVAOfficeSetup-v0.7.204.exe)   |
| **Linux** — Debian / Ubuntu          | x86_64, glibc 2.34+ (Ubuntu 22.04 or newer)           | [PROVAOffice_0.7.204_amd64.deb](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/PROVAOffice_0.7.204_amd64.deb)   |
| **Linux** — Fedora / RHEL / openSUSE | x86_64, glibc 2.34+ (Fedora 35+, RHEL 9+, Leap 15.6+) | [GenOffice-0.7.204.x86_64.rpm](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/GenOffice-0.7.204.x86_64.rpm) |
| **Linux** — other distributions      | x86_64, glibc 2.34+, FUSE 2                           | [GenOffice-0.7.204.AppImage](https://github.com/Genspark-ai/PROVAOffice/releases/download/v0.7.204/GenOffice-0.7.204.AppImage)     |

All builds come from `main`; the macOS and Windows installers are signed.
Older versions are on the [Releases](https://github.com/Genspark-ai/PROVAOffice/releases) page.

### Installing on Linux

The deb installs with apt — it pulls in the dependencies and adds PROVAOffice
to the applications menu:

```bash
sudo apt install ./PROVAOffice_0.7.204_amd64.deb
```
...
| --------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `apps/docs`     | **PROVAOffice Docs**     | `.docx` word processor. Byte-preserving round trip: only dirty paragraphs are regenerated (paragraph patch), everything else in the original file is kept byte-for-byte, so opening and saving never breaks layout in Word. Paginated view whose line metrics reproduce the original document's layout, tracked changes, comments, styles, equations, ink.                                                                                                                                                                                                      |
| `apps/sheets`   | **PROVAOffice Sheets**   | `.xlsx` spreadsheet. UI built on the open-source [Univer](https://github.com/dream-num/univer) core (Apache-2.0) with a large layer of in-house extensions; `.xlsx` import/export runs through an in-house Rust sidecar (calamine + IronCalc), charts are rendered in-house (Konva), plus pivot tables, slicers, conditional formatting, and formula tracing.                                                                                                                                                                                                   |
| `apps/slides`   | **PROVAOffice Slides**   | `.pptx` presentations. In-house `.pptx` parse/render/edit engine with masters, charts, cropping, ink, and text shaping (HarfBuzz metrics).                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `apps/pdf`      | **PROVAOffice PDF**      | `.pdf` viewer/editor on [pdf.js](https://github.com/mozilla/pdf.js) (Apache-2.0) + [pdf-lib](https://github.com/Hopding/pdf-lib) (MIT): annotations, forms, outlines, stamps, signatures, page operations, and printing support. True text editing — paragraph selection with in-block reflow, alignment restoration, original-font preservation — and content-stream image insert/edit, all rewriting page content streams through [PDFium](https://pdfium.googlesource.com/pdfium/) wasm (BSD-3-Clause) with subset-embedded fonts — no cover-up annotations. |
| `apps/markdown` | **PROVAOffice Markdown** | `.md` / `.markdown` editor: Tiptap block editor over plain Markdown files — headings, lists, tables, images, code blocks — saved back as plain Markdown, hosted in shell tabs.                                                                                                                                                                                                                                                                                                                                                                                  |
| `apps/shell`    | **PROVAOffice**          | The suite shell: home screen, tabbed hosting of the five editors, light/dark/system theme, auto-update.                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
**AI backend (PROVA-AI).** The apps sign in to a PROVA-AI account through a
device-code flow; no model API key is entered or stored by the user. Model
calls route through the PROVA-AI proxy (Claude, GPT, and Gemini families).
The same account also unlocks the PROVA-AI ("gsk") tool endpoints the agents
...
- `packages/ai-provider` — provider abstraction and streaming for the model
  backends.
- `packages/ai-search` — PROVA-AI auth + web/image search tools.
...
(`cargo` on PATH); `npm run build -w @prova/sheets` compiles it
automatically.
...
**Is PROVAOffice free?**
Yes. PROVAOffice is free and open-source under the Apache-2.0 license — no
trial, no paid tier for the apps themselves.

**Can PROVAOffice open Microsoft Word, Excel, and PowerPoint files?**
Yes. PROVAOffice opens and saves native `.docx`, `.xlsx`, and `.pptx` files.
...
in to a PROVA-AI account and need a network connection.

**Can PROVAOffice edit PDF files?**
...
PROVAOffice would not be possible without these open-source projects:
...
PROVAOffice is licensed under the [Apache License 2.0](LICENSE), with one
exception: the `ee/` directory is reserved for future enterprise modules and
is covered by the [PROVAOffice Enterprise License](ee/LICENSE).

The PROVAOffice and PROVA-AI names and logos are trademarks of Mainfunc, Inc.
