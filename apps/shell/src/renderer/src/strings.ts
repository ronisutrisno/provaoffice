...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle: '在网页端用 PROVA-AI 创建的项目。编辑在浏览器中继续——点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 PROVA-AI 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountGenspark: 'PROVA-AI 账号',
    account: '账号',
    login: '登录',
    loginGenspark: '登录 PROVA-AI 账号',
    loggedIn: '已登录',
    loggedInGenspark: '已登录 PROVA-AI',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 PROVA-AI,请检查网络或代理设置',
    ...
    starPromptTitle: '喜欢 PROVAOffice 吗？',
    starPromptTitleN: '你已经用 PROVAOffice 打开了 {n} 个文档',
    starPromptBody: 'PROVAOffice 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 PROVAOffice，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 PROVAOffice',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'PROVAOffice 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ PROVA-AI 积分**',
    ...
    onbNote3: 'AI 功能可能消耗 PROVA-AI 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Projects created on the web with PROVA-AI. Editing continues in your browser — click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your PROVA-AI account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountGenspark: 'PROVA-AI Account',
    account: 'Account',
    login: 'Sign in',
    loginGenspark: 'Sign in with PROVA-AI',
    loggedIn: 'Signed in',
    loggedInGenspark: 'Signed in to PROVA-AI',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach PROVA-AI — check your network or proxy settings',
    ...
    starPromptTitle: 'Enjoying PROVAOffice?',
    starPromptTitleN: "You've opened {n} documents with PROVAOffice",
    starPromptBody:
      'PROVAOffice is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like PROVAOffice, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ PROVA-AI credits**',
    ...
    onbNote3: 'AI features may consume PROVA-AI credits.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Web で PROVA-AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'PROVA-AI アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountGenspark: 'PROVA-AI アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginGenspark: 'PROVA-AI アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInGenspark: 'PROVA-AI にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'PROVA-AI に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    starPromptTitle: 'PROVAOffice はいかがですか？',
    starPromptTitleN: 'PROVAOffice で {n} 件のドキュメントを開きました',
    starPromptBody:
      'PROVAOffice は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'PROVAOffice が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'PROVAOffice へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'PROVAOffice はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ PROVA-AI クレジット**',
    ...
    onbNote3: 'AI 機能は PROVA-AI クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'PROVA-AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'PROVA-AI 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountGenspark: 'PROVA-AI 계정',
    account: '계정',
    login: '로그인',
    loginGenspark: 'PROVA-AI 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInGenspark: 'PROVA-AI에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'PROVA-AI에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    starPromptTitle: 'PROVAOffice가 마음에 드시나요?',
    starPromptTitleN: 'PROVAOffice로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'PROVAOffice는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'PROVAOffice가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'PROVAOffice에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'PROVAOffice는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ PROVA-AI 크레딧**',
    ...
    onbNote3: 'AI 기능은 PROVA-AI 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      "Projets créés sur le web avec PROVA-AI. L'édition continue dans votre navigateur — cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte PROVA-AI pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountGenspark: 'Compte PROVA-AI',
    account: 'Compte',
    login: 'Se connecter',
    loginGenspark: 'Se connecter avec PROVA-AI',
    loggedIn: 'Connecté',
    loggedInGenspark: 'Connecté à PROVA-AI',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre PROVA-AI — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    starPromptTitle: 'PROVAOffice vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec PROVAOffice',
    starPromptBody:
      'PROVAOffice est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si PROVAOffice vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits PROVA-AI**',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits PROVA-AI.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Mit PROVA-AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    account: 'Konto',
    login: 'Anmelden',
    loginGenspark: 'Mit PROVA-AI anmelden',
    loggedIn: 'Angemeldet',
    loggedInGenspark: 'Bei PROVA-AI angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'PROVA-AI ist nicht erreichbar — prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    starPromptTitle: 'Gefällt Ihnen PROVAOffice?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit PROVAOffice geöffnet',
    starPromptBody:
      'PROVAOffice ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen PROVAOffice gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Proyectos creados en la web con PROVA-AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de PROVA-AI para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountGenspark: 'Cuenta de PROVA-AI',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginGenspark: 'Iniciar sesión con PROVA-AI',
    loggedIn: 'Sesión iniciada',
    loggedInGenspark: 'Sesión iniciada en PROVA-AI',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con PROVA-AI — compruebe su red o la configuración del proxy',
    ...
    starPromptTitle: '¿Te gusta PROVAOffice?',
    starPromptTitleN: 'Has abierto {n} documentos con PROVAOffice',
    starPromptBody:
      'PROVAOffice es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta PROVAOffice, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de PROVA-AI**',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de PROVA-AI.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย PROVA-AI แก้ไขต่อได้ในเบราว์เซอร์ — คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี PROVA-AI เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountGenspark: 'บัญชี PROVA-AI',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginGenspark: 'ลงชื่อเข้าใช้ด้วย PROVA-AI',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInGenspark: 'ลงชื่อเข้าใช้ PROVA-AI แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ PROVA-AI ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    starPromptTitle: 'ชอบ PROVAOffice ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย PROVAOffice ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'PROVAOffice ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ PROVAOffice ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต PROVA-AI กว่า 1,000**',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต PROVA-AI',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan PROVA-AI. Pengeditan berlanjut di browser — klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun PROVA-AI untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountGenspark: 'Akun PROVA-AI',
    account: 'Akun',
    login: 'Masuk',
    loginGenspark: 'Masuk dengan PROVA-AI',
    loggedIn: 'Sudah masuk',
    loggedInGenspark: 'Sudah masuk ke PROVA-AI',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke PROVA-AI — periksa jaringan atau pengaturan proxy Anda',
    ...
    starPromptTitle: 'Suka PROVAOffice?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan PROVAOffice',
    starPromptBody:
      'PROVAOffice gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai PROVAOffice, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit PROVA-AI**',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit PROVA-AI.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с PROVA-AI. Редактирование продолжается в браузере — нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт PROVA-AI, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountGenspark: 'Учётная запись PROVA-AI',
    account: 'Учётная запись',
    login: 'Войти',
    loginGenspark: 'Войти через PROVA-AI',
    loggedIn: 'Вход выполнен',
    loggedInGenspark: 'Выполнен вход в PROVA-AI',
    ...
    loginNetworkError: 'Не удаётся подключиться к PROVA-AI — проверьте сеть или настройки прокси',
    ...
    starPromptTitle: 'Нравится PROVAOffice?',
    starPromptTitleN: 'Вы уже открыли {n} документов в PROVAOffice',
    starPromptBody:
      'PROVAOffice — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится PROVAOffice, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов PROVA-AI**',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты PROVA-AI.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام PROVA-AI. يستمر التحرير في المتصفح — انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب PROVA-AI لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountGenspark: 'حساب PROVA-AI',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginGenspark: 'تسجيل الدخول باستخدام PROVA-AI',
    loggedIn: 'تم تسجيل الدخول',
    loggedInGenspark: 'تم تسجيل الدخول إلى PROVA-AI',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ PROVA-AI — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    starPromptTitle: 'هل أعجبك PROVAOffice؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في PROVAOffice',
    starPromptBody: 'PROVAOffice مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك PROVAOffice، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في PROVAOffice',
    ...
    onbBody2:
      'لا يزال PROVAOffice في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة PROVA-AI**',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة PROVA-AI.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Projetos criados na web com o PROVA-AI. A edição continua no navegador — clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta PROVA-AI para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountGenspark: 'Conta PROVA-AI',
    account: 'Conta',
    login: 'Entrar',
    loginGenspark: 'Entrar com a PROVA-AI',
    loggedIn: 'Conectado',
    loggedInGenspark: 'Conectado à PROVA-AI',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao PROVA-AI — verifique sua rede ou as configurações de proxy',
    ...
    starPromptTitle: 'Gostando do PROVAOffice?',
    starPromptTitleN: 'Você já abriu {n} documentos com o PROVAOffice',
    starPromptBody:
      'O PROVAOffice é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do PROVAOffice, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao PROVAOffice',
    ...
    onbBody2:
      'O PROVAOffice ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos PROVA-AI**',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos PROVA-AI.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Progetti creati sul web con PROVA-AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account PROVA-AI per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountGenspark: 'Account PROVA-AI',
    account: 'Account',
    login: 'Accedi',
    loginGenspark: 'Accedi con PROVA-AI',
    loggedIn: 'Accesso effettuato',
    loggedInGenspark: 'Accesso effettuato a PROVA-AI',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere PROVA-AI — controlla la rete o le impostazioni del proxy',
    ...
    starPromptTitle: 'Ti piace PROVAOffice?',
    starPromptTitleN: 'Hai aperto {n} documenti con PROVAOffice',
    starPromptBody:
      'PROVAOffice è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace PROVAOffice, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti PROVA-AI**',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti PROVA-AI.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą PROVA-AI. Edycja jest kontynuowana w przeglądarce — kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto PROVA-AI, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountGenspark: 'Konto PROVA-AI',
    account: 'Konto',
    login: 'Zaloguj się',
    loginGenspark: 'Zaloguj się przez PROVA-AI',
    loggedIn: 'Zalogowano',
    loggedInGenspark: 'Zalogowano do PROVA-AI',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z PROVA-AI — sprawdź sieć lub ustawienia proxy',
    ...
    starPromptTitle: 'Podoba Ci się PROVAOffice?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w PROVAOffice',
    starPromptBody:
      'PROVAOffice jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się PROVAOffice, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów PROVA-AI**',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty PROVA-AI.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met PROVA-AI. Bewerken gaat verder in je browser — klik op een project om het te openen.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginGenspark: 'Inloggen met PROVA-AI',
    loggedIn: 'Ingelogd',
    loggedInGenspark: 'Ingelogd bij PROVA-AI',
    ...
    loginNetworkError: 'Kan PROVA-AI niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    starPromptTitle: 'Bevalt PROVAOffice?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met PROVAOffice',
    starPromptBody:
      'PROVAOffice is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als PROVAOffice je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan PROVA-AI. Penyuntingan diteruskan dalam pelayar — klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun PROVA-AI untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountGenspark: 'Akaun PROVA-AI',
    account: 'Akaun',
    login: 'Log masuk',
    loginGenspark: 'Log masuk dengan PROVA-AI',
    loggedIn: 'Telah log masuk',
    loggedInGenspark: 'Telah log masuk ke PROVA-AI',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke PROVA-AI — semak rangkaian atau tetapan proksi anda',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan PROVAOffice',
    starPromptBody:
      'PROVAOffice percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka PROVAOffice, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke PROVAOffice',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'PROVAOffice masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit PROVA-AI**',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit PROVA-AI.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם PROVA-AI. העריכה נמשכת בדפדפן — לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון PROVA-AI כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountGenspark: 'חשבון PROVA-AI',
    account: 'חשבון',
    login: 'התחברות',
    loginGenspark: 'התחברות עם PROVA-AI',
    loggedIn: 'מחובר',
    loggedInGenspark: 'מחובר ל-PROVA-AI',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-PROVA-AI — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    starPromptTitle: 'נהנים מ-PROVAOffice?',
    starPromptTitleN: 'פתחת {n} מסמכים עם PROVAOffice',
    starPromptBody: 'PROVAOffice חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם PROVAOffice מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-PROVAOffice',
    ...
    onbBody2:
      'PROVAOffice עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות PROVA-AI**',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של PROVA-AI.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle:
      'PROVA-AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है — खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने PROVA-AI खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountGenspark: 'PROVA-AI खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginGenspark: 'PROVA-AI से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInGenspark: 'PROVA-AI में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'PROVA-AI से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    starPromptTitle: 'PROVAOffice पसंद आ रहा है?',
    starPromptTitleN: 'आपने PROVAOffice में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'PROVAOffice मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको PROVAOffice पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'PROVAOffice में आपका स्वागत है',
    ...
    onbBody2:
      'PROVAOffice अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ PROVA-AI क्रेडिट**',
    ...
    onbNote3: 'AI सुविधाएँ PROVA-AI क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'PROVA-AI Projects',
    cloudSubtitle: '在網頁端用 PROVA-AI 建立的專案。編輯在瀏覽器中繼續——點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 PROVA-AI 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountGenspark: 'PROVA-AI 帳號',
    account: '帳號',
    login: '登入',
    loginGenspark: '登入 PROVA-AI 帳號',
    loggedIn: '已登入',
    loggedInGenspark: '已登入 PROVA-AI',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 PROVA-AI，請檢查網路或代理設定',
    ...
    starPromptTitle: '喜歡 PROVAOffice 嗎？',
    starPromptTitleN: '你已經用 PROVAOffice 開啟了 {n} 個文件',
    starPromptBody: 'PROVAOffice 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 PROVAOffice，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 PROVAOffice',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'PROVAOffice 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ PROVA-AI 點數**',
    onbJoinGenTeam: '加入 GenTeam',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 PROVA-AI 點數。',
    onbBack: '上一步',
  },
} as const
