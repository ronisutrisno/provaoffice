...
/* Screenshot-automation hook (fidelity-compare): window.__PROVAOfficeHidePhPrompts = true +
...
const getHidePhPrompts = () =>
  !!(window as { __PROVAOfficeHidePhPrompts?: boolean }).__PROVAOfficeHidePhPrompts
