...
export function AiComposer({
  ...
  /** content inside the box above the textarea (attachment chips, …) — PROVA-AI composer style */
  readonly header?: React.ReactNode
  /** extra controls at the left of the footer (attach button, toggles, …) */
  readonly footerStart?: React.ReactNode
  /** compact variant: no hint text, icon-only enter/stop button (PROVA-AI composer style) */
